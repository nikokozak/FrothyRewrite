...
test-unity: $(UNITY_TEST_BINARY) $(UNITY_I2C_TEST_BINARY) $(UNITY_LIB_NATIVES_TEST_BINARY) $(UNITY_PERSIST_TIER_TEST_BINARY) $(UNITY_T12_SERVO_TEST_BINARY) $(UNITY_T21_MEM_TEST_BINARY)
	./$(UNITY_TEST_BINARY)
...
_test-unity-run: $(UNITY_TEST_BINARY) $(UNITY_I2C_TEST_BINARY) $(UNITY_LIB_NATIVES_TEST_BINARY) $(UNITY_PERSIST_TIER_TEST_BINARY) $(UNITY_T12_SERVO_TEST_BINARY) $(UNITY_T21_MEM_TEST_BINARY)
	./$(UNITY_TEST_BINARY)
	./$(UNITY_I2C_TEST_BINARY)
	./$(UNITY_LIB_NATIVES_TEST_BINARY)
	./$(UNITY_PERSIST_TIER_TEST_BINARY)
