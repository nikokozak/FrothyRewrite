...
test-unity: $(UNITY_TEST_BINARY) $(UNITY_I2C_TEST_BINARY) $(UNITY_LIB_NATIVES_TEST_BINARY) $(UNITY_PERSIST_TIER_TEST_BINARY)
	./$(UNITY_TEST_BINARY)
...
_test-unity-run: $(UNITY_TEST_BINARY) $(UNITY_I2C_TEST_BINARY) $(UNITY_LIB_NATIVES_TEST_BINARY) $(UNITY_PERSIST_TIER_TEST_BINARY)
	./$(UNITY_TEST_BINARY)
	./$(UNITY_I2C_TEST_BINARY)
	./$(UNITY_LIB_NATIVES_TEST_BINARY)
	./$(UNITY_PERSIST_TIER_TEST_BINARY)
...
$(UNITY_PERSIST_TIER_TEST_BINARY): $(UNITY_PERSIST_TIER_TEST_SOURCES) $(KERNEL_DEPS) $(BUILD_DEPS) \
		test/unity/unity.h test/unity/unity_internals.h | $(BUILD_DIR)
	$(FR_CC) $(FR_CFLAGS) -DFR_INCLUDE_TEST_NATIVES=1 $(UNITY_PERSIST_TIER_TEST_SOURCES) $(FR_LDFLAGS) -o $@
