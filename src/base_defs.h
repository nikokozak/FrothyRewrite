...
enum {
  ...
  FR_SLOT_CONSOLE_DEFAULT = FR_SLOT_AFTER_PULSE + 1,
  FR_SLOT_CONSOLE_INFO = FR_SLOT_AFTER_PULSE + 2,
  FR_SLOT_AFTER_CONSOLE = FR_SLOT_AFTER_PULSE + 3,
#else
  FR_SLOT_AFTER_CONSOLE = FR_SLOT_AFTER_PULSE,
#endif
#if FR_FEATURE_BLE
  FR_SLOT_BLE_ON = FR_SLOT_AFTER_CONSOLE,
  FR_SLOT_BLE_INFO = FR_SLOT_AFTER_CONSOLE + 1,
#if FR_BLE_ENABLE_OBSERVER
  FR_SLOT_BLE_SCAN_START = FR_SLOT_AFTER_CONSOLE + 2,
  FR_SLOT_BLE_SCAN_STOP = FR_SLOT_AFTER_CONSOLE + 3,
  FR_SLOT_BLE_SCAN_NEXT = FR_SLOT_AFTER_CONSOLE + 4,
  FR_SLOT_BLE_SCAN_RSSI = FR_SLOT_AFTER_CONSOLE + 5,
  FR_SLOT_BLE_SCAN_PEER = FR_SLOT_AFTER_CONSOLE + 6,
  FR_SLOT_BLE_SCAN_FLAGS = FR_SLOT_AFTER_CONSOLE + 7,
  FR_SLOT_BLE_SCAN_DATA = FR_SLOT_AFTER_CONSOLE + 8,
  FR_SLOT_AFTER_BLE = FR_SLOT_AFTER_CONSOLE + 9,
#else
  FR_SLOT_AFTER_BLE = FR_SLOT_AFTER_CONSOLE + 2,
#endif
#else
  FR_SLOT_AFTER_BLE = FR_SLOT_AFTER_CONSOLE,
#endif
#if FR_INCLUDE_TEST_NATIVES && FR_FEATURE_TEXT
  FR_SLOT_FIRE_EVENT = FR_SLOT_AFTER_BLE,
  FR_SLOT_BOARD_CAPABILITY_BASE = FR_SLOT_AFTER_BLE + 1,
#else
  FR_SLOT_BOARD_CAPABILITY_BASE = FR_SLOT_AFTER_BLE,
#endif
