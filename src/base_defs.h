...
enum {
  ...
  FR_SLOT_AFTER_NET = FR_SLOT_AFTER_EVENT + 4,
#else
  FR_SLOT_AFTER_NET = FR_SLOT_AFTER_EVENT,
#endif
#if FR_INCLUDE_TEST_NATIVES && FR_FEATURE_TEXT
  FR_SLOT_FIRE_EVENT = FR_SLOT_AFTER_NET,
  FR_SLOT_BOARD_LOCAL_BASE = FR_SLOT_AFTER_NET + 1,
#else
  FR_SLOT_BOARD_LOCAL_BASE = FR_SLOT_AFTER_NET,
#endif
};
