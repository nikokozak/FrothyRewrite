...
enum {
  ...
  FR_SLOT_CELLS_WRITE = FR_SLOT_AFTER_CONSOLE + 1,
  FR_SLOT_AFTER_CELLS = FR_SLOT_AFTER_CONSOLE + 2,
#else
  FR_SLOT_AFTER_CELLS = FR_SLOT_AFTER_CONSOLE,
#endif
#if FR_INCLUDE_TEST_NATIVES && FR_FEATURE_TEXT
  FR_SLOT_FIRE_EVENT = FR_SLOT_AFTER_CELLS,
  FR_SLOT_BOARD_CAPABILITY_BASE = FR_SLOT_AFTER_CELLS + 1,
#else
  FR_SLOT_BOARD_CAPABILITY_BASE = FR_SLOT_AFTER_CELLS,
#endif
