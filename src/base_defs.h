...
enum {
  ...
  FR_SLOT_PAD_EMIT_BYTE = FR_SLOT_AFTER_I2C + 1,
  FR_SLOT_PAD_LEN = FR_SLOT_AFTER_I2C + 2,
  FR_SLOT_PAD_TYPE = FR_SLOT_AFTER_I2C + 3,
  FR_SLOT_PAD_PEEK_BYTE = FR_SLOT_AFTER_I2C + 4,
#if FR_FEATURE_TEXT
  FR_SLOT_PAD_PACK = FR_SLOT_AFTER_I2C + 5,
  FR_SLOT_BOARD_LOCAL_BASE = FR_SLOT_AFTER_I2C + 6,
#else
  FR_SLOT_BOARD_LOCAL_BASE = FR_SLOT_AFTER_I2C + 5,
#endif
#else
