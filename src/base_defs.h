...
enum {
  ...
  FR_SLOT_PAD_EMIT_BYTE = FR_SLOT_AFTER_PWM + 1,
  FR_SLOT_PAD_LEN = FR_SLOT_AFTER_PWM + 2,
  FR_SLOT_PAD_TYPE = FR_SLOT_AFTER_PWM + 3,
  FR_SLOT_PAD_PEEK_BYTE = FR_SLOT_AFTER_PWM + 4,
#if FR_FEATURE_TEXT
  FR_SLOT_PAD_PACK = FR_SLOT_AFTER_PWM + 5,
  FR_SLOT_BOARD_LOCAL_BASE = FR_SLOT_AFTER_PWM + 6,
#else
  FR_SLOT_BOARD_LOCAL_BASE = FR_SLOT_AFTER_PWM + 5,
#endif
#else
